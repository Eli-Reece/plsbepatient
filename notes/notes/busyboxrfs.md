...
It's not the exact file/location but you can infer
...
I had an issue building libffi 3.4.2 due to my gcc version being too high. Just
updated its config with a new a newer package.
